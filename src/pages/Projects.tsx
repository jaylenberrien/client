    ...
    <div id='projects' className='min-h-screen flex flex-col mx-20 p-10 text-slate-300 -mt-32'> 
        ...
        >
          <div className='inline-block mr-5'>
            ...
            <div>{!isLoading && (<Blurhash hash='L3P%O.?b~q%M00xu00s:00D%M{Ri' width='100' height="100" resolutionX={32} resolutionY={32} punch={1} />)} { true && (<img alt='Picture of Wordle game' src={imgWW} className='preview-size'/>)}</div>
          </div>
