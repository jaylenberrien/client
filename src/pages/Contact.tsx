...
const Contact: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <p className='mt-20 text-lg'>Made by <a href='https://github.com/jaylenberrien/my-portfolio' title='See repo for portfolio' className='text-cyan-300'>Jaylen Berrien</a></p>
    </motion.div>
  )
}
